    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 hover-lift" data-testid="education-bs-software-engineering">
          ...
          {/* Intermediate */}
          <div className="bg-card border border-border rounded-2xl p-8 hover-lift" data-testid="education-intermediate-cs">
            <div className="flex items-start space-x-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-secondary to-accent rounded-lg flex items-center justify-center flex-shrink-0">
