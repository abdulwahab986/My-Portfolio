        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="hidden lg:grid lg:grid-cols-3 lg:grid-rows-3 gap-4 w-full max-w-3xl">
            ...
            <button
              ...
              className="section-card hover:scale-105 transition-all cursor-pointer px-4 py-2 flex flex-row items-center gap-3 group animate-slide-from-left justify-self-center"
              data-testid="tab-experience"
              style={{animationDelay: '0.8s'}}
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center group-hover:shadow-lg transition-all flex-shrink-0">
                <Briefcase className="w-5 h-5 text-white" />
              </div>
              <div className="flex flex-col items-start">
                <h3 className="text-xs font-bold leading-tight">Experience</h3>
                <p className="text-[10px] text-muted-foreground leading-tight whitespace-nowrap">1 year at Innovador</p>
              </div>
            </button>
            ...
            <button
              ...
              className="section-card hover:scale-105 transition-all cursor-pointer px-4 py-2 flex flex-row items-center gap-3 group animate-slide-from-right justify-self-center"
              data-testid="tab-projects"
              style={{animationDelay: '0.8s'}}
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-secondary to-accent flex items-center justify-center group-hover:shadow-lg transition-all flex-shrink-0">
                <FolderOpen className="w-5 h-5 text-white" />
              </div>
              <div className="flex flex-col items-start">
                <h3 className="text-xs font-bold leading-tight">Projects</h3>
                <p className="text-[10px] text-muted-foreground leading-tight whitespace-nowrap">Testing portfolio</p>
              </div>
            </button>
            ...
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-primary flex items-center justify-center group-hover:shadow-lg transition-all flex-shrink-0">
                <Code className="w-5 h-5 text-white" />
              </div>
              <div className="flex flex-col items-start">
                <h3 className="text-xs font-bold leading-tight">Skills</h3>
                <p className="text-[10px] text-muted-foreground leading-tight whitespace-nowrap">Testing expertise</p>
              </div>
            </button>
            ...
            <button
              ...
              style={{animationDelay: '1s'}}
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-secondary to-primary flex items-center justify-center group-hover:shadow-lg transition-all flex-shrink-0">
                <GraduationCap className="w-5 h-5 text-white" />
              </div>
              <div className="flex flex-col items-start">
                <h3 className="text-xs font-bold leading-tight">Education</h3>
                <p className="text-[10px] text-muted-foreground leading-tight whitespace-nowrap">BS Software Eng.</p>
              </div>
            </button>
          </div>
